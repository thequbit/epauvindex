...
def main(argv):
    ...
    print "[SCRAPER] Getting zipcode from database for satte: '{0}'...".format(state)

    zcodes = getzipcodes(state)

    print "[SCRAPER] Successfully returned {0} zipcodes.".format(len(zcodes))

    print "[SCRAPER] Starting scraper.  Working on {0} zipcodes.".format(len(zcodes))
